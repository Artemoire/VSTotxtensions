...
{
    internal class CopyCtorRefactor : IRefactoringComputer
    {
        public async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            else
            {
                ...
                RegisterCopy(context, @class, newClass, paramSyntax.Identifier.Text);
            }
        }

        private void RegisterCopy(CodeRefactoringContext context, ClassDeclarationSyntax @class, ClassDeclarationSyntax newClass, string paramName)
        {
            var action = CodeAction.Create(
                "Copy Property Values From '" + paramName + "'",
                ct =>
